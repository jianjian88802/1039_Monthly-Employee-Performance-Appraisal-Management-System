  ...
  <div>
    ...
    >  
     <el-row>
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='yuangong'"  label="员工邮箱" prop="yuangongyouxiang">
          <el-input v-model="ruleForm.yuangongyouxiang"               placeholder="员工邮箱" clearable></el-input>
        </el-form-item>
      </el-col>
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
      ...
      if( 'yuangong' ==this.flag && this.ruleForm.yuangongyouxiang&&(!isEmail(this.ruleForm.yuangongyouxiang))){
        this.$message.error(`员工邮箱应输入邮箱格式`);
        return
      }
