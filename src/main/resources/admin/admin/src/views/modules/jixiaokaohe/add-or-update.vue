<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="绩效月份" prop="jixiaoyuefen">
          <el-input v-model="ruleForm.jixiaoyuefen" 
              placeholder="绩效月份" clearable  :readonly="ro.jixiaoyuefen"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="绩效月份" prop="jixiaoyuefen">
              <el-input v-model="ruleForm.jixiaoyuefen" 
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="员工考勤" prop="yuangongkaoqin">
          <el-select v-model="ruleForm.yuangongkaoqin" placeholder="请选择员工考勤">
            <el-option
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="工作态度" prop="gongzuotaidu">
          <el-select v-model="ruleForm.gongzuotaidu" placeholder="请选择工作态度">
            <el-option
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="业务技能" prop="yewujineng">
          <el-select v-model="ruleForm.yewujineng" placeholder="请选择业务技能">
            <el-option
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="工作绩效" prop="gongzuojixiao">
          <el-select v-model="ruleForm.gongzuojixiao" placeholder="请选择工作绩效">
            <el-option
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="绩效等级" prop="jixiaodengji">
          <el-select v-model="ruleForm.jixiaodengji" placeholder="请选择绩效等级">
            <el-option
                v-for="(item,index) in jixiaodengjiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="绩效等级" prop="jixiaodengji">
	      <el-input v-model="ruleForm.jixiaodengji"
                placeholder="绩效等级" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.zongdefen = true;
          ...
          if(o=='jixiaodengji'){
            this.ruleForm.jixiaodengji = obj[o];
	    this.ro.jixiaodengji = true;
            continue;
          }
        }
      }
